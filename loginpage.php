...
<head>
  ...
  <link rel="stylesheet" href="../iii/css/login1.css" />
</head>
    ...
    <div class="container" id="container">
      <div class="form-container sign-up-container">
        <form name="signup" method="POST">
          ...
          <label for="inputEmail" class="sr-only">Email address</label><span id="mailIsWrong">&nbsp;</span>
          <input name="email" type="email" id="signUpEmail" class="form-control" placeholder="Email address" required autofocus>
          ...
          <input name="phone" type="number" id="signUpPhone" class="form-control" placeholder="Phone " required>
          <span id="phoneIsWrong">&nbsp;</span>
      ...
      <div class="overlay-container">
        <div class="overlay">
          ...
          <div class="overlay-panel  overlay-right">
            ...
            <p>Grab oppurtunities directly at your place</p>
...
<script>
  ...
  var mail = document.getElementById('signUpEmail');
  ...
  mail.addEventListener('blur', () => {
    ...
    if (regexMail.test(strMail)) {
      document.getElementById('signUpEmail').style.backgroundColor = "greenyellow";
    } else {
      document.getElementById('signUpEmail').style.backgroundColor = "red";
      document.getElementById('mailIsWrong').innerHTML = "Invalid Email Id";
      document.getElementById('mailIsWrong').style.color = "red";
    }
  })
  ...
  phone.addEventListener('blur', () => {
    ...
    if (regexPhone.test(strPhone)) {
      document.getElementById('signUpPhone').style.backgroundColor = "greenyellow";
    } else {
      document.getElementById('signUpPhone').style.backgroundColor = "red";
      document.getElementById('phoneIsWrong').innerHTML = "Phone Number should be of 10 digits";
      document.getElementById('phoneIsWrong').style.color = "red";
    }
  })
